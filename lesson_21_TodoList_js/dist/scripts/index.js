...
const createTask = () => {
  ...
  (0, _tasksGetWhey.setTask)(newTask).then(() => (0, _tasksGetWhey.getTasksList)()).then(newTasksList => {
...
const checkboxChange = event => {
  ...
  (0, _tasksGetWhey.updateTask)(taskId, updatedTask).then(() => (0, _tasksGetWhey.getTasksList)()).then(newTasksList => {
    (0, _storage.setItem)('tasksList', newTasksList);
    listItem.innerHTML = '';
    renderListItems((0, _storage.getItem)('tasksList'));
  });
